...
/*!
* Forward declaration of the data structure for the StatechartIfaceSensores interface scope.
*/
typedef struct StatechartIfaceSensores StatechartIfaceSensores;
...
#define SCVI_STATECHART__REGION0_AVANZAR 0
#define SCVI_STATECHART__REGION0_IZQ 0
#define SCVI_STATECHART__REGION0_DER 0
...
typedef enum  {
	...
	Statechart_sensores_sensor_D_1,
	Statechart_sensores_sensor_D_0,
	Statechart_sensores_sensor_I_1,
	Statechart_sensores_sensor_I_0
} StatechartEventID;
...
typedef enum
{
	...
	Statechart__region0_Avanzar,
	Statechart__region0_Izq,
	Statechart__region0_Der
} StatechartStates;


/*! Type declaration of the data structure for the StatechartIfaceSensores interface scope. */
struct StatechartIfaceSensores
{
	sc_boolean sensor_D_1_raised;
	sc_boolean sensor_D_0_raised;
	sc_boolean sensor_I_1_raised;
	sc_boolean sensor_I_0_raised;
};
...
struct Statechart
{
	...
	StatechartIfaceSensores ifaceSensores;
...
/*! Raises the in event 'sensor_D_1' that is defined in the interface scope 'sensores'. */ 
extern void statechart_sensores_raise_sensor_D_1(Statechart* handle);
/*! Raises the in event 'sensor_D_0' that is defined in the interface scope 'sensores'. */ 
extern void statechart_sensores_raise_sensor_D_0(Statechart* handle);
/*! Raises the in event 'sensor_I_1' that is defined in the interface scope 'sensores'. */ 
extern void statechart_sensores_raise_sensor_I_1(Statechart* handle);
/*! Raises the in event 'sensor_I_0' that is defined in the interface scope 'sensores'. */ 
extern void statechart_sensores_raise_sensor_I_0(Statechart* handle);
